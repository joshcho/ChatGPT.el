...
*Note*: It seems OpenAI is preventing people from accessing ChatGPT in non-standard ways. Make sure to check the instructions at [[https://github.com/acheong08/ChatGPT/wiki/Setup][acheong08/ChatGPT]] if your method of authentication breaks. revChatGPT has issues, and will be switching to a different wrapper.
