...
*Note*: It seems OpenAI is preventing people from accessing its API in various ways. Make sure to check the instructions at [[https://github.com/acheong08/ChatGPT/wiki/Setup][acheong08/ChatGPT]] if your method of authentication breaks.
