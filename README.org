...
*Note*: It seems OpenAI is preventing people from accessing its API in various ways. Make sure to check the instructions at [[https://github.com/acheong08/ChatGPT/wiki/Setup][acheong08/ChatGPT]] from time to time to see if anything changes.
